...
public class Main {
    ...
    private static class DES {
        ...
        int[] PC2 = { 14, 17, 11, 24, 1,  5,  3,  28, 15, 6, 21, 10, 23, 19, 12, 4,  26, 8,  16, 7, 27, 20, 13, 2,  41,
                52, 31, 37, 47, 55, 30, 40, 51, 45, 33, 48, 44, 49, 39, 56, 34, 53, 46, 42, 50, 36, 29, 32 };

        int[] EP = { 32, 1,  2,  3,  4,  5,  4,  5,  6,  7, 8,  9,  8,  9,  10, 11, 12, 13, 12, 13, 14, 15, 16, 17, 16,
        ...
        String[] getKeys(String key) {
            ...
            for (int i = 0; i < 16; i++) {
                key = leftCircularShift(key.substring(0, 7), shiftBits[i]) + leftCircularShift(key.substring(7, 14),
                        shiftBits[i]);
        ...
        String encrypt(String plainText, String key) {
            ...
            System.out.println("After splitting: L0="
